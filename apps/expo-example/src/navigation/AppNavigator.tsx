    ...
    >
      ...
      >
        ...
        <Stack.Screen 
          name="BasicDemo" 
          component={BasicDemo} 
          options={{ title: 'Basic Connection' }}
        />
        <Stack.Screen 
          name="PathTypesDemo" 
          component={PathTypesDemo} 
          options={{ title: 'Path Types' }}
        />
        <Stack.Screen 
          name="AnimationsDemo" 
        ...
        <Stack.Screen 
          ...
          options={{ title: 'Socket Positions' }}
        />
        <Stack.Screen 
          name="LabelsDemo" 
        ...
        <Stack.Screen 
          ...
          options={{ title: 'Multiple Lines' }}
        />
        <Stack.Screen 
          name="ImperativeApiDemo" 
          component={ImperativeApiDemo} 
          options={{ title: 'Imperative API' }}
        />
        <Stack.Screen 
          name="EffectsDemo" 
          component={EffectsDemo} 
          options={{ title: 'Effects & Styling' }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
