    ...
    <View style={styles.container}>
      ...
      <View style={styles.demoSection}>
        ...
        <View style={styles.demo}>
          ...
          <View style={[styles.box, styles.purpleBox, { bottom: 40, left: 150 }]}>
            <Text style={styles.boxText}>Fixed</Text>
          </View>
          <LeaderLine
            start={{ element: animatedRef }}
            end={{ point: { x: 180, y: 160 } }}
            color="#2ecc71"
            strokeWidth={2}
            path="fluid"
            updateThreshold={16} // Update every frame
          />
        </View>
      </View>
      ...
      <View style={styles.info}>
        ...
        <Text style={styles.infoText}>• Lines update automatically when refs move</Text>
        <Text style={styles.infoText}>• Use updateThreshold to control update frequency</Text>
        <Text style={styles.infoText}>• Toggle visibility for show/hide effects</Text>
        <Text style={styles.infoText}>• Works with React Native Animated API</Text>
      </View>
    </View>
  );
}
