...
export default function ImperativeApiDemo() {
  ...
  const { createLine, removeLine, updateLine, removeAllLines, getLineIds, LeaderLineContainer } = useLeaderLineManager();
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.demo}>
        <View ref={box1Ref} style={[styles.box, { backgroundColor: '#3498db', top: 30, left: 30 }]}>
          <Text style={styles.boxText}>1</Text>
        </View>
        <View ref={box2Ref} style={[styles.box, { backgroundColor: '#e74c3c', top: 30, right: 30 }]}>
          <Text style={styles.boxText}>2</Text>
        </View>
        <View ref={box3Ref} style={[styles.box, { backgroundColor: '#2ecc71', bottom: 30, left: 30 }]}>
          <Text style={styles.boxText}>3</Text>
        </View>
        <View ref={box4Ref} style={[styles.box, { backgroundColor: '#f39c12', bottom: 30, right: 30 }]}>
      ...
      <View style={styles.controls}>
        <TouchableOpacity style={[styles.button, styles.createButton]} onPress={handleCreateLine}>
          <Text style={styles.buttonText}>Create Line</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={[styles.button, styles.multiButton]} onPress={handleCreateMultiple}>
          <Text style={styles.buttonText}>Create Multiple</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={[styles.button, styles.updateButton]} onPress={handleUpdateLines}>
          <Text style={styles.buttonText}>Update All</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={[styles.button, styles.removeButton]} onPress={handleRemoveLast}>
          <Text style={styles.buttonText}>Remove Last</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={[styles.button, styles.clearButton]} onPress={removeAllLines}>
