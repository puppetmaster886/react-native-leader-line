      ...
      <View ref={demoRef} style={styles.demo}>
        ...
        <View
          ...
          style={[
            styles.node,
            styles.surroundingNode,
            { bottom: 30, left: "50%", marginLeft: -25 },
          ]}
        >
        ...
        <View
          ref={topRightRef}
          style={[styles.node, styles.surroundingNode, { top: 60, right: 60 }]}
        >
        ...
        <View
          ref={topLeftRef}
          style={[styles.node, styles.surroundingNode, { top: 60, left: 60 }]}
        >
