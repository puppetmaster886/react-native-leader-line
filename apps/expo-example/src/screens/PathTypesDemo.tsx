    ...
    <ScrollView style={styles.container} ref={containerRef}>
      <View style={styles.description}>
        <Text style={styles.descriptionText}>
          Different path algorithms for drawing connections. Each path type has
          unique characteristics suitable for different use cases.
        </Text>
      </View>
      ...
      <View style={styles.interactiveSection}>
        ...
        {(selectedPath === "arc" || selectedPath === "fluid") && (
          <View style={styles.curvatureControl}>
            <Text style={styles.curvatureLabel}>
...
/>`}</Text>
        ...
        {pathTypes.map(({ type, description, color }) => (
          <View key={type} style={styles.pathExample}>
            <View style={styles.pathHeader}>
              <Text style={[styles.pathTitle, { color }]}>
                {type.toUpperCase()}
              </Text>
      ...
      <View style={styles.tips}>
        ...
        <Text style={styles.tipText}>
          • <Text style={styles.bold}>straight</Text>: Simple, direct
          connections
        </Text>
        <Text style={styles.tipText}>
          • <Text style={styles.bold}>arc</Text>: Elegant curves for aesthetic
          appeal
        </Text>
        <Text style={styles.tipText}>
          • <Text style={styles.bold}>fluid</Text>: Natural, organic connections
        </Text>
        <Text style={styles.tipText}>
          • <Text style={styles.bold}>magnet</Text>: Clean L-shaped paths for
          diagrams
        </Text>
        <Text style={styles.tipText}>
          • <Text style={styles.bold}>grid</Text>: Structured layouts and
          flowcharts
        </Text>
      </View>
    </ScrollView>
