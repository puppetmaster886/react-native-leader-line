        ...
        {demos.map((demo, index) => (
          ...
          >
            <Text
              style={[
                styles.tabText,
                activeDemo === index && styles.activeTabText,
              ]}
            >
              {demo.title}
            </Text>
    ...
    <View style={styles.demo}>
      ...
      <View ref={containerRef} style={styles.demoArea}>
        ...
        <View
          ...
          style={[
            styles.box,
            { top: 20, left: 120, backgroundColor: "#e74c3c" },
          ]}
        >
        ...
        <View
          ...
          style={[
            styles.box,
            { top: 80, right: 20, backgroundColor: "#3498db" },
          ]}
        >
        ...
        <View
          ...
          style={[
            styles.box,
            { bottom: 20, left: 120, backgroundColor: "#2ecc71" },
          ]}
        >
        ...
        <View
          ...
          style={[
            styles.box,
            { top: 80, left: 20, backgroundColor: "#f39c12" },
          ]}
        >
    ...
    <View style={styles.demo}>
      ...
      <View style={styles.demoArea}>
        <View
          ...
          style={[
            styles.box,
            { top: 100, left: 20, backgroundColor: "#34495e" },
          ]}
        >
        ...
        {plugTypes.map((plugType, index) => (
          <View key={plugType}>
            ...
            >
              <Text style={[styles.boxText, { fontSize: 10 }]}>
                {plugType.toUpperCase()}
              </Text>
            </View>
    ...
    <View style={styles.demo}>
      ...
      <View style={styles.demoArea}>
        <View
          ...
          style={[
            styles.box,
            { top: 60, left: 30, backgroundColor: "#e74c3c" },
          ]}
        >
        ...
        <View
          ...
          style={[
            styles.box,
            { top: 120, right: 30, backgroundColor: "#3498db" },
          ]}
        >
