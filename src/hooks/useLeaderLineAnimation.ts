...
export const useLeaderLineAnimation = (
  options: UseLeaderLineAnimationOptions = {}
) => {
  ...
  const getEasing = useCallback((timingFunction: TimingFunction) => {
  ...
  const show = useCallback(
    (
      ...
      const duration = animationOptions?.duration || options.duration || 300;
      const easing = getEasing(
        animationOptions?.timing || options.easing || "ease"
      );
  ...
  const pulse = useCallback(
    (
      ...
      const duration = animationOptions?.duration || 200;
  ...
  const shake = useCallback(
    (
      ...
      const duration = animationOptions?.duration || 500;
  ...
  const bounce = useCallback(
    (animationOptions?: AnimationOptions): Promise<void> => {
  ...
  const elastic = useCallback(
    (animationOptions?: AnimationOptions): Promise<void> => {
      const duration = animationOptions?.duration || 800;
